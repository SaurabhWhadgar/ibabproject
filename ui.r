                    ...
                    dashboardBody(
                      tabItems(
                        ...
                        tabItem(tabName = "human",
                                ...
                                fluidRow(
                                  box(title = "Normal miRNA Expression", status = "primary", solidHeader = TRUE, 
                                      collapsible = TRUE,
                                ...
                                fluidRow(
                                  box(title = "Normal miRNA Expression", status = "warning", solidHeader = TRUE, 
                        ...
                        tabItem(tabName = "all",
                                h2("Human ALL"),
                                fluidRow(
                                  box(title = "miRNA expression in ALL condition", status = "danger", solidHeader = TRUE, 
                                ...
                                fluidRow(
                                  box(title = "RAG expression in ALL condition", status = "danger", solidHeader = TRUE, 
                        ...
                        tabItem(tabName = "mouse",
                                ...
                                fluidRow(
                                  box(title = "RAG Expression in Disease State", status = "info", solidHeader = TRUE, 
                        ...
                        tabItem(tabName = "ragreg",
                                ...
                                fluidRow(
                                  box(title = "RAG Regulator and their Expression", status = "danger", solidHeader = TRUE, 
